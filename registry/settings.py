...
SECRET_KEY = '!pp^ox82-xhim$9n8d+pslegbxcb)coim7ujy692t_mn443@49'
...
DATA_UPLOAD_MAX_MEMORY_SIZE = 100 * 1024 * 1024 * 1024
...
LOGGING = {
    ...
    'formatters': {
        'verbose': {
            'format': '[{levelname} {levelno}] {asctime} {filename} {funcName} at line {lineno} == {message}',
            'style': '{',
        },
        'simple': {
